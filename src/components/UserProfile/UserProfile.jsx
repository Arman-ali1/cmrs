  ...
  return (
    <div className="container ml-32">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="p-10 bg-gray-900 text-white min-h-screen flex flex-col items-center w-2/3 border-4 border-blue-600">
          ...
          <div className="w-full max-w-3xl mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
