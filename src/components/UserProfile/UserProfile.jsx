...
export default function UserProfile() {
  ...
  // Assume your Redux state has a userAuth slice with a user object
  ...
  const [formData, setFormData] = useState({
    ...
    phone: "123-456-7890",
    patreonId: "patreon123", // if this data is not available in the realtime object, it remains unchanged
    membership: "Premium",
    username: "johndoe",
    country: "USA",
    roleId: "2",
  ...
  // Update formData when realtime user data changes
  useEffect(() => {
    if (user) {
      setFormData((prev) => ({
        ...prev,
        ...
        roleId: user.role_id ? user.role_id.toString() : prev.roleId,
      }));
    }
  }, [user]);
        ...
        <div className="p-10 bg-gray-900 text-white min-h-screen flex flex-col items-center lg:w-2/3 w-100 border-4 border-blue-600">
          ...
          <div className="flex flex-col items-center mb-8">
            <Avatar
              ...
              sx={{
                ...
                boxShadow: "0px 4px 10px rgba(236, 72, 153, 0.5)",
            ...
            <p className="text-gray-400">Country: {formData.country}</p>
          ...
          <div className="w-full max-w-3xl mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="p-6 bg-gray-800 rounded-lg shadow-lg transition-all hover:shadow-xl">
              ...
              <p>
                <strong>Membership:</strong> {formData.membership}
              </p>
              <p>
            ...
            <div className="p-6 bg-gray-800 rounded-lg shadow-lg transition-all hover:shadow-xl">
              ...
              <p>
                <strong>Patreon ID:</strong> {formData.patreonId}
              </p>
              <p>
